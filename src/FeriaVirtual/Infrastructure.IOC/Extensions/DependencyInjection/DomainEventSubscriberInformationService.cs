...
namespace FeriaVirtual.Infrastructure.IOC.Extensions.DependencyInjection
{
    ...
    {
        public static IServiceCollection AddDomainEventSubscriberInformationService
        ...
        private static void FormatSubscribers
            (Assembly assembly, TypeInfo handlerInterfaceType, Dictionary<Type, DomainEventSubscriberInformation> information)
        {
