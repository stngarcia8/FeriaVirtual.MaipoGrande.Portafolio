...
namespace FeriaVirtual.Infrastructure.SeedWork.Events.RabbitMQ
{
        ...
        : IEventBusConfiguration
    {
        ...
        public RabbitMqEventBusConfiguration
            (DomainEventSubscribersInformation domainEventSubscribersInformation, RabbitMqConfig config, string domainEventExchange = "domain_events")
        {
        ...
        private IDictionary<string, object> RetryQueueArguments
            (string domainEventExchange, string domainEventQueue) =>
