    ...
    public class UserGenerator
    {
        ...
        public CreateUserDto NewUser()
        {
            return new CreateUserDto {
                Firstname = "Daniel", Lastname = "García Asathor",
                Dni = "12345678-8", ProfileId = 1,
                Username = "d.garcial", Password = "@Password.1234@",
        ...
        public UpdateUserDto ExistingUser()
        {
            return new UpdateUserDto { 
                ...
                Firstname = "User-modified", Lastname="For Test - modified", 
                Dni="09876543-0", ProfileId=2,
                CredentialId=new Guid("94155b73-0866-d8aa-77dd-00b100bc0022"),
                Username="user-modified.test", Password="@Test.1234@",
                Email="user.test.modified@domain.com", IsActive=1
            };
        }
