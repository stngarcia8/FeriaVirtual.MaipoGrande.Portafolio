-- File name    : populScript-userModule.sql
...
VALUES ('1', 'd.garcial', '9cf9951f2bb3fedc9f709c7314fb9fb672c7a66e', 'd.garcial@alumnos.duoc.cl', 1);
insert into fv_user.user_credential (CredentialId, Username, Password, Email, IsActive)
...
INSERT INTO fv_user.employee (EmployeeId, CredentialId, ProfileId, FirstName, LastName)
VALUES ('1', '1', 1, 'Daniel', 'Garcia Asathor');



prompt Inserting example customers for test.;
insert into fv_user.customer (CustomerId, CredentialId, ProfileId, FirstName, LastName, Dni)
